 ...
 function showCategory(category) {
    if(category == 'phones') {
        for(let i = 0; i < products.phones.length; i++) {
            divProducts.insertAdjacentHTML('beforeend', getProductMarkup(products.phones[i]));
        }
    }   
    else if(category == 'tablets') {
        for(let j = 0; j < products.tablets.length; j++) {
            divProducts.insertAdjacentHTML('beforeend', getProductMarkup(products.tablets[j]));
        }
    }   
    else if(category == 'tv') {
        for(let k = 0; k < products.tv.length; k++) {
            divProducts.insertAdjacentHTML('beforeend', getProductMarkup(products.tv[k]));
        }
    }
}
